...
First run ```git clone https://github.com/robloxboy24/Bongo-Cat-Pi-Apps-Download``` then run ```mv ~/Bongo-Cat-Pi-Apps-Download /pi-apps/apps``` then, ```cp ~/pi-apps/apps/Bongo-Cat-For-Pi-Apps-Download/Bongo Cam /pi-apps/apps``` then, ```rm ~/pi-apps/apps/Bongo-Cat-Pi-Apps-Download```then, ```rm ~/pi-apps/data/preload/timestamps```
#3. Last step!
