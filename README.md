...
First run ```git clone https://github.com/robloxboy24/Bongo-Cat-Pi-Apps-Download``` then run ```mv ~/Bongo-Cat-Pi-Apps-Download ~/pi-apps/apps``` then, ```mv ~/pi-apps/apps/Bongo-Cat-Pi-Apps-Download/Bongo_Cam ~/pi-apps/apps``` then, ```sudo rm -rf ~/pi-apps/apps/Bongo-Cat-Pi-Apps-Download``` then, ```rm ~/pi-apps/data/preload/timestamps```
#3. Last step!
