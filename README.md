...
First run ```git clone https://github.com/robloxboy24/Bongo-Cat-Pi-Apps-Download``` then run ```mv ~/Bongo-Cat-Pi-Apps-Download/install-32 ~/Desktop``` then, ```sudo chmod a+x ~/Desktop/install-32``` then, ```~/Desktop/install-32```
#3. Last step!
